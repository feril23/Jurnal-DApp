            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mt-4 text-sm text-gray-600">
              ...
              <div className="flex items-start space-x-3 col-span-1 md:col-span-2">
                ...
                <div className="flex-grow">
                  ...
                  {/* --- TOMBOL BARU UNTUK MELIHAT FILE --- */}
                  <a
                    href={fileUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block mt-2 text-sm text-white bg-gray-700 font-semibold py-1 px-3 rounded-md hover:bg-gray-800 transition"
                  >
                    Lihat File di IPFS ↗
                  </a>
                </div>
